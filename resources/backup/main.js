...
document.addEventListener('DOMContentLoaded', function () {
 ...
 if (triggerFormPanen) {
  ...
  // ---- CHAT KE PETANI / PENGURUS (data asli + Pusher, dengan fallback form tamu) ----
  if (window.SiTaniRealtime) {
    window.SiTaniRealtime.initChatWidget();
  }

  // ---- GRAFIK / CHART.JS (data asli dari tabel panens) ----
  if (window.SiTaniRealtime) {
    window.SiTaniRealtime.initCharts();
  }
});